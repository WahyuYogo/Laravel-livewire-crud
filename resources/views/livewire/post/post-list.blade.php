<div>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="seacrh" wire:model.live="keyword">
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="deletePost({{ $item->id }})" class="btn btn-danger">{{ __('Delete') }}</button>
            </div>
        </div>
    </div>
</div>
